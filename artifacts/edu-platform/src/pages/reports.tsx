...
function SkillRadar({ data }: { data: { reading: number; writing: number; listening: number; speaking: number } }) {
  const chartData = [
    { skill: "Đọc", value: data.reading },
    { skill: "Viết", value: data.writing },
    { skill: "Nghe", value: data.listening },
    { skill: "Nói", value: data.speaking },
  ];
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={report.scoreDistribution} margin={{ left: -20 }}>
                    <CartesianGrid strokeDasharray="3 3" />
